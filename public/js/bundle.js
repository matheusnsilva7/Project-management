    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          type === "login" ? btn.textContent = "Login" : document.querySelector(".btn").textContent = "create";
          btn.disabled = false;
...
var createTask = document.querySelector(".taskForm");
var formNewTask = document.querySelector(".formTask");
...
if (background) {
  background.addEventListener("click", function () {
    if (formNewProject) formNewProject.classList.remove("active");else if (formNewTask) formNewTask.classList.remove("active");
  });
}
if (columns.length != 0) {
  var _ref3;
