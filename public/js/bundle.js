      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "".concat(type === "login" ? "Logged in" : "Sign up", " succesfully!"));
        ...
        case 8:
          ...
          type === "login" ? btn.textContent = "Login" : btn.textContent = "create";
          btn.disabled = false;
        case 13:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "Eror logging out! Try again.");
        case 10:
        case "end":
...
var updateSettings = function updateSettings(_x3, _x4) {
  return (_ref3 = _ref3 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data, type) {
    var url, res;
...
},{"../../node_modules/axios/index":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var newProject = document.querySelector(".add-card");
var createTask = document.querySelector(".formnewtask");
var containernewTask = document.querySelector(".createTask");
var background = document.querySelectorAll(".background");
var formSingup = document.querySelector(".formSignup");
var logOutBtn = document.querySelectorAll(".btnLogout");
var information = document.querySelector(".information");
var informationContainer = document.querySelector(".maininfoContainer");
var deleteUser = document.querySelectorAll(".deleteUser");
var changeName = document.querySelector(".projectChange");
var createProject = document.querySelector(".projectform");
var formNewProject = document.querySelector(".formProject");
var changePassword = document.querySelector(".changePassword");
var containerSettingsBtn = document.querySelector(".user-container");
var settingsContainer = document.querySelector(".setting-container");
var containerTask = document.querySelectorAll(".container-completed");
var containerDelete = document.querySelector(".containerDelete");
if (form) {
...
if (containerSettingsBtn) {
  containerSettingsBtn.addEventListener("click", function () {
    settingsContainer.classList.toggle("setting-container-btn");
  });
}
if (logOutBtn) logOutBtn.forEach(function (e) {
  return e.addEventListener("click", _login.logout);
});
if (change) {
  var _ref;
  change.addEventListener("submit", function (_x) {
...
if (changePassword) {
  var _ref2;
  changePassword.addEventListener("submit", function (_x2) {
...
if (formSingup) {
  formSingup.addEventListener("submit", function (e) {
    ...
    var passwordConfirm = e.target[3].value;
    (0, _login.login)({
      name: name,
      email: email,
      password: password,
...
if (background) {
  background.forEach(function (e) {
    return e.addEventListener("click", function () {
      if (formNewProject) formNewProject.classList.remove("active");else if (containernewTask) containernewTask.classList.remove("active");
    });
  });
}
if (columns.length != 0) {
  ...
  document.addEventListener("dragend", function (_x3) {
    return (_ref3 = _ref3 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var res;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _index.default)({
              method: "PATCH",
              url: "/api/v1/tasks/".concat(e.target.id),
              data: {
  ...
  columns.forEach(function (items) {
    var _ref4;
    items.addEventListener("dragover", function (_x4) {
      return (_ref4 = _ref4 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
        var dragging;
...
if (createProject) {
  var _ref5;
  createProject.addEventListener("submit", function (_x5) {
    return (_ref5 = _ref5 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
      var name, description, res;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 8:
            res = _context5.sent;
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "project created successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 800);
            }
...
if (createTask) {
  var _ref6;
  createTask.addEventListener("submit", function (_x6) {
    return (_ref6 = _ref6 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
      var btn, formData, data, res;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 10:
            res = _context6.sent;
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Task created successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 800);
            }
...
if (changeName) {
  var _ref7;
  changeName.addEventListener("submit", function (_x7) {
    return (_ref7 = _ref7 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
      var btn, formData, data, res;
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            btn = document.querySelector(".update");
            _context7.prev = 1;
            e.preventDefault();
            ...
            return (0, _index.default)({
              method: "PATCH",
              url: "/api/v1/projects/".concat(window.location.href.split("/")[4]),
              data: data
            });
          case 9:
            res = _context7.sent;
...
if (newMember) {
  var _ref8;
  newMember.addEventListener("submit", function (_x8) {
    return (_ref8 = _ref8 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(e) {
      var btn, member, res;
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            btn.textContent = "Update...";
            btn.disabled = true;
            member = e.target[0].value;
            _context8.next = 8;
            return (0, _index.default)({
              method: "PATCH",
              url: "/api/v1/projects/updateMembers/".concat(window.location.href.split("/")[4]),
              data: {
                member: member
              }
            });
...
if (deleteUser) {
  deleteUser.forEach(function (e) {
    var _ref9;
    e.addEventListener("click", function (_x9) {
      return (_ref9 = _ref9 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(e) {
        var member, res;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return (0, _index.default)({
                method: "PATCH",
                url: "/api/v1/projects/deleteMembers/".concat(window.location.href.split("/")[4]),
                data: {
                  member: member
                }
              });
            case 5:
              res = _context9.sent;
              if (res.data.status === "success") {
                (0, _alerts.showAlert)("success", "successfully deleted user!");
                window.setTimeout(function () {
                  location.reload(true);
                }, 800);
              }
...
if (containerTask) {
  containerTask.forEach(function (e) {
    e.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
      var _ref11, res, data;
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            ...
            return (0, _index.default)({
              method: "GET",
              url: "/api/v1/tasks/".concat(e.id)
            });
          case 4:
            res = _context13.sent;
            data = res.data.data.data;
            informationContainer.innerHTML = "";
            informationContainer.innerHTML += "\n        <div class=\"informationContainer\">\n              <span class=\"material-symbols-outlined taskSettings\">more_horiz</span>\n              <h3>Name</h3>\n              <h2>".concat(data.name ? data.name : "", "</h2>\n              <h3>Description</h3>\n              <p>").concat(data.description ? data.description : "", "</p>\n              <div>\n                  <h3>Difficult</h3>\n                  <h5 class=\"").concat(data.difficult ? data.difficult : "", "\">").concat(data.difficult ? data.difficult : "", "</h5>\n                  <h3>Status</h3>\n                  <h5 class=\"").concat(data.status ? data.status : "", "\">").concat(data.status ? data.status : "", "</h5>\n              </div>\n              </div>");
            ...
            document.querySelector(".taskSettings").addEventListener("click", function (_x10) {
              return (_ref11 = _ref11 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(e) {
                var _ref12, _ref13;
                return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                  while (1) switch (_context12.prev = _context12.next) {
                    case 0:
                      informationContainer.innerHTML = "";
                      informationContainer.innerHTML += "\n                <form class=\"formTask\" id=".concat(data.id, ">\n                    <h2>").concat(data.name, "</h2>\n                    <label for=\"taskName\">Name</label>\n                    <input id=\"taskName\" type=\"text\" name=\"name\" value=").concat(data.name, " required>\n                    <label for=\"taskDescription\">Description</label>\n                    <textarea id=\"taskDescription\" name=\"description\" cols=\"30\" rows=\"4\">").concat(data.description ? data.description : "", "</textarea>\n                    <label for=\"taskDate\">Due date</label>\n                    <input id=\"taskDate\" type=\"date\" name=\"dueDate\" value=\"").concat(data.dueDate ? data.dueDate.slice(0, 10) : "", "\" required>\n                    <label>Difficult</label>\n                    <div class=\"formDiv\">\n                        <input type=\"radio\" id=\"easy\" name=\"difficult\" value=\"Easy\" ").concat(data.difficult === "Easy" && "checked", ">\n                        <label for=\"easy\">Easy</label>\n                        <input type=\"radio\" id=\"medium\" name=\"difficult\" value=\"Medium\" ").concat(data.difficult === "Medium" && "checked", ">\n                        <label for=\"medium\">Medium</label>\n                        <input type=\"radio\" id=\"hard\" name=\"difficult\" value=\"Hard\" ").concat(data.difficult === "Hard" && "checked", ">\n                        <label for=\"hard\">Hard</label>\n                    </div>\n                    <label>Status</label>\n                    <div class=\"formDiv\">\n                        <input type=\"radio\" id=\"review\" name=\"status\" value=\"Review\" ").concat(data.status === "Review" && "checked", ">\n                        <label for=\"review\">Review</label>\n                        <input type=\"radio\" id=\"progress\" name=\"status\" value=\"Progress\" ").concat(data.status === "Progress" && "checked", ">\n                        <label for=\"progress\">Progress</label>\n                        <input type=\"radio\" id=\"completed\" name=\"status\" value=\"Completed\"  ").concat(data.status === "Completed" && "checked", ">\n                        <label for=\"completed\">Completed</label>\n                        <input type=\"radio\" id=\"deferred\" name=\"status\" value=\"Deferred\"  ").concat(data.status === "Deferred" && "checked", ">\n                        <label for=\"deferred\">Deferred</label>\n                    </div>\n                    <div class=\"containerButton\">\n                    <div class=\"deleteTask\">Delete Task</div>\n                    <button>Update</button>\n                    </div>\n                </form>");
                      document.querySelector(".deleteTask").addEventListener("click", function (_x11) {
                        return (_ref12 = _ref12 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(e) {
                          var _res;
                          return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                            while (1) switch (_context10.prev = _context10.next) {
                              case 0:
                                ...
                                return (0, _index.default)({
                                  method: "DELETE",
                                  url: "/api/v1/tasks/".concat(e.target.parentElement.parentElement.id)
                                });
                              case 3:
                                _res = _context10.sent;
                                (0, _alerts.showAlert)("success", "Task deleted successfully!");
                                window.setTimeout(function () {
                                  location.reload(true);
                                }, 800);
                                _context10.next = 11;
                      ...
                      document.querySelector(".formTask").addEventListener("submit", function (_x12) {
                        return (_ref13 = _ref13 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(e) {
                          var btn, formData, _data, _res2;
                          return _regeneratorRuntime().wrap(function _callee11$(_context11) {
                            while (1) switch (_context11.prev = _context11.next) {
                              case 0:
                                ...
                                btn.disabled = true;
                                formData = new FormData(e.target);
                                _data = Object.fromEntries(formData);
                                _context11.next = 9;
                                return (0, _index.default)({
                                  method: "PATCH",
                                  url: "/api/v1/tasks/".concat(e.target.id),
                              ...
                              case 9:
                                ...
                                if (_res2.data.status === "success") {
                                  (0, _alerts.showAlert)("success", "successfully update task!");
                                  window.setTimeout(function () {
                                    location.reload(true);
                                  }, 800);
                                }
...
if (document.querySelector(".deleteBackground")) {
  document.querySelector(".deleteBackground").addEventListener("click", function () {
...
if (document.querySelector(".yes")) {
  var _ref14;
  document.querySelector(".yes").addEventListener("click", function (_x13) {
    return (_ref14 = _ref14 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(e) {
      var res;
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          ...
          case 4:
            res = _context14.sent;
            (0, _alerts.showAlert)("success", "successfully deleted Project!");
            window.setTimeout(function () {
              location.assign("/projects");
            }, 800);
            _context14.next = 13;
